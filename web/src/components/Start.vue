  ...
  <div class="demo-step-container">
    ...
    <div id="content">
      <mu-stepper :activeStep="activeStep" orientation="vertical">
        <mu-step>
          <mu-step-label>下载|Download</mu-step-label>
          <mu-step-content>
            <p>Github fork & clone</p>
            <mu-raised-button label="NEXT" class="demo-step-button" @click="handleNext" primary/>
          </mu-step-content>
        </mu-step>
        <mu-step>
          <mu-step-label>安装依赖项|Install Dependences</mu-step-label>
          <mu-step-content>
            <p>npm run install | npm run Xweb</p>
            <mu-raised-button label="NEXT" class="demo-step-button" @click="handleNext" primary/>
            <mu-flat-button label="BACK" class="demo-step-button" @click="handlePrev"/>
          </mu-step-content>
        </mu-step>
        <mu-step>
          <mu-step-label>启动可视化网站|Start Journey</mu-step-label>
          <mu-step-content>
            <p>npm run all | npm run Xweb</p>
  ...
  computed: {
    content() {
      ...
      switch (this.activeStep) {
        case 0:
          message =
            'SETTING Environment git clone https://github.com/yutiansut/QUANTAXIS_SPIDER'
          break
        case 1:
