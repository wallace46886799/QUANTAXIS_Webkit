      ...
      axios
        ...
        .then(response => {
          ...
          for (var i = 0; i < data1.length; i++) {
            var temp_day = []
            temp_day.push(parseFloat(data1[i]['open']))
            temp_day.push(parseFloat(data1[i]['close']))
            temp_day.push(parseFloat(data1[i]['low']))
            temp_day.push(parseFloat(data1[i]['high']))
            kline.push(temp_day)
            k_time.push(data1[i]['date'])
          }
