...
export default new Router({
  ...
  },
  {
    ...
    {
      'path': '/personal/stockroe',
      component: require('@/components/Personal/stockroe.vue')
    },
    {
      'path': '/personal/stockdividend',
      component: require('@/components/Personal/stockdividend.vue')
    },
    {
      'path': '/personal/pepb',
      component: require('@/components/Personal/pepb.vue')
    },
    {
